...
I started to get serious about programming when I did my master research in astrophysics,
which I had to work with Linux, supercomputers, simulation, and data analysis.
Then, I came to Leiden to do my PhD in social science,
which I gained some experiences in databases, textual analysis, network analysis,
and agent-based simulation.

Because of some catastrophic engineering mistakes made by the developers in a foreign institute,
the data and the scripts for my primary PhD research project were completely erased on the server,
and the data platform has stopped functioning since then.
To rescue my PhD, I decided to dive deep into software development.
I dedicated over a year to develop an agent-based simulation framework for interstellar social model
...
to independently create such a cool project, and I have shared it in multiple social science conferences
...
I always try to fix it and contribute a pull request back if possible.
I particularly like to work on C++ software because it helps me
to build up my engineering skill in a lower level language,
