...
\recipient
  ...
  {55 Chung Hau Street Homantin, Kowloon, Hong Kong}
% The date on the letter, default is the date of compilation
\letterdate{\today}
% The title of the letter
\lettertitle{Job Application for Physics \& ICT Teacher (advertised on jump.mingpao.com)}
% How the letter is opened
\letteropening{Dear Principal Dr. Ho Yuk Fan,}
