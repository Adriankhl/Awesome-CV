...
\recipient
  ...
  {3-5 Lek Yuen Street, Lek Yuen Estate, Shatin, N.T}
% The date on the letter, default is the date of compilation
\letterdate{\today}
% The title of the letter
\lettertitle{Job Application for Physics Graduate Master Teacher (advertised on jump.mingpao.com)}
% How the letter is opened
\letteropening{Dear Principal,}
