...
\recipient
  ...
  {33 Inverness Road, Kowloon City, Kowloon, Hong Kong}
% The date on the letter, default is the date of compilation
\letterdate{\today}
% The title of the letter
\lettertitle{Job Application for Math \& M2 Teacher (advertised on jump.mingpao.com)}
% How the letter is opened
\letteropening{Dear Principal Cara Cheng,}
