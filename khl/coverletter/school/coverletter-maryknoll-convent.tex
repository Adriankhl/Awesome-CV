...
\recipient
  ...
  {5 Ho Tung Road, Kowloon, Hong Kong}
% The date on the letter, default is the date of compilation
\letterdate{\today}
% The title of the letter
\lettertitle{Job Application for Substitute Teacher in Mathematics and/or Mathematics Teacher (advertised on jump.mingpao.com)}
% How the letter is opened
\letteropening{Dear Principal Meimei Chan,}
