...
\recipient
  {Munsang College}
  {8 Dumbarton Road, Kowloon City, Kowloon, HKSAR}
% The date on the letter, default is the date of compilation
\letterdate{\today}
% The title of the letter
\lettertitle{Job Application for Physics Teacher (advertised on jump.mingpao.com)}
% How the letter is opened
\letteropening{Dear Principal Dr. Yip Chi Sio,}
...
I am writing to express my strong interest in the ``Physics Teacher'' position at Munsang College. As a researcher with a deep passion for education and being a Christian myself, I am excited about the opportunity to contribute to your school's mission and make a positive impact on students' lives.
...
As a researcher, I have also developed a strong proficiency in technology, particularly in software development and data analysis. I am confident in my ability to utilize, customize, evaluate, and even develop technologies for learning and teaching purposes. Given the increasing emphasis on technology and STEAM education, I am excited to bring my expertise to the forefront in this position.
