...
%---------------------------------------------------------
  \cventry
    {\emph{Python, SQL}} % Research project
    {FAIR text-mining and citation analysis} % Research organization
    {} % Location
    {Jun. 2023 - present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item{Analyzed the diffusion of FAIR principles in academic publications}
        \item{Investigated the references to FAIR principles in policy documents}
      \end{cvitems}
    }
