...
## Why do you want to work in IT in the bank? (maximum 200 words)
Banks deal with vast amounts of data, sensitive information, and complex systems, which introduce interesting challenges about efficiency and security. Also, technology has become more prominent in the banking industry. Many banks have embraced modern technology stacks. As a developer who has spent a significant amount of time to work on Kotlin projects, I am excited to see that Kotlin is playing an important role in ING. Being part of the IT team gives me the chance to contribute to meaningful and interesting projects that form the backbone of the bank and our society.

## Which two future IT challenges for ING do you see and which challenge would you like to tackle? Please explain why. (maximum 200 words)*
One of the classic IT challenges is cybersecurity. It is crucial to design robust systems for things like authentication and monitoring to ensure to prevent frauds. Another IT challenge is to provide enriched digital services to compete with new FinTech companies. If I have to choose a challenge to tackle, I am leaning towards developing novel digital functionalities. As a developer who has worked on innovative simulation frameworks and games, I am pretty good at turning creative ideas into functioning applications. Therefore, it would be great if I can utilize my capability to implement solutions to suit the need of customers. Nonetheless, the new functionalities also have to ensure its security, which leads to a mix of both challenges.

## Where in the IT domain do you want to bring added value? (maximum 200 words)
I have experience in developing backend services using Kotlin so I am happy to continue in that direction. Also, I have used Kotlin to develop graphical interfaces for PC and Android, and mobile development is something that I enjoy. I have done quite a few data-oriented research, so I am naturally interested in data engineer, such as building big data pipeline and monitoring services. In general, as demonstrated in my wide range of open source contributions, I am able to adapt and thrive in different domains.
