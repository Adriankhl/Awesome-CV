...
Dedicated to providing additional Physics Olympiad training and STEM education.
...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{STEM}{: Software engineering, Data analysis, Research (Mathematics, Physics, Computational Social Science)}
    }}
 \end{itemize}
